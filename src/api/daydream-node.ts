...
let daydreamDeviceName = "Daydream controller";
let daydreamDeviceId = "db7df138e6f4466aa8d01a514fa80991";
let daydreamPrimaryServiceUuid = "fe55";
let daydreamMainCharacteristicUuid = "0000000110001000800000805f9b34fb";
...
function DaydreamController() {
      ...
      peripheral.discoverServices([daydreamPrimaryServiceUuid], function(error, services) {
          if (services.length > 0) {
              ...
              primaryService.discoverCharacteristics([daydreamMainCharacteristicUuid], function(error, characteristics) {
                let mainCharacteristic = characteristics[0];
                ...
                mainCharacteristic.subscribe(function(error) {
                  console.log("daydream controller notifications on nhvhchc");
                });
              });
            }
        });
  ...
  let onStateChangeCallback:any = function () {};
